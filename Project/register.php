...
if (isset($_POST["register"])) {
    ...
    if ($password == $confirm) {
        echo "Hooray! The passwords match!<br>";
    }else {
        echo "Sorry, the passwords do not match<br>";
        $isValid = false;
    }
    ...
    if ($isValid) {
        ...
        if (isset($db)) {
            ...
            $e = $stmt->errorInfo();
            if ($e[0] == "00000") {
                echo "<br>Welcome! You have successfully register with us, please sign on.";
            }else {
                if ($e[0] == "23000") {//code for duplicate entry
                    echo "<br>Username or email is already registered, please try again";
                }else {
